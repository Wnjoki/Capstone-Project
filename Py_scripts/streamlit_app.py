...
def load_model():
    model = AutoModelForQuestionAnswering.from_pretrained('C:/Users/njoki/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base')
    tokenizer = AutoTokenizer.from_pretrained('C:/Users/njoki/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base', use_fast=False)
    return model, tokenizer

st.cache(show_spinner=False, persist=True)
def load_questions():
	with open('C:/Users/njoki/OneDrive/Desktop/Capstone Project/CUAD_v1/CUAD_v1.json') as json_file:
...
if (not len(paragraph)==0) and not (len(question)==0):
	...
	prediction = run_prediction(question, paragraph, 'C:/Users/njoki/OneDrive/Desktop/Capstone Project/Cuad Models/roberta-base')
